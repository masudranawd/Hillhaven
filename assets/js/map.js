  ...
  const markerData = [
   {
    ...
    },
    {
      ...
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>Hillview Community Club</h4><p>1 Hillview Rise</p><h5><img src="./assets/image/icons/walk.png" alt="">  <strong>1.1 min</strong> walk</h5>',
    
    },
    {
      position: { lat: 1.363190, lng: 103.764130 }, // Amenities
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>HillV2</h4><p>4 Hillview Rise</p><h5><img src="./assets/image/icons/walk.png" alt="">  <strong>2.2 mins</strong> walk</h5>',
    },
    {
      position: { lat: 1.357730, lng: 103.768210 }, // Amenities
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>The Rail Mall</h4><p>380 Upper Bukit Timah Road</p><h5><img src="./assets/image/icons/car.png" alt="">  <strong>2 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.37878, lng: 103.76300 }, // Amenities
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>Hillion Mall</h4><p>185A Jelebu Road</p> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>8.5 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.38030, lng: 103.76423 }, // Amenities
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>Bukit Panjang Plaza</h4> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>12.6 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.38067, lng: 103.75996 }, // Amenities
      icon: './assets/image/map/Amenities-map.png',
      content:'<h4>Junction 10</h4><p>178 Lompang Road</p><h5><img src="./assets/image/icons/car.png" alt="">  <strong>13.7 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.36330, lng: 103.76737 }, // Connectivity
      icon: './assets/image/map/connectivity-map.png',
      content:'<h4>Hillview MRT Station</h4><p>Upper Bukit Timah Road</p><h5><img src="./assets/image/icons/walk.png" alt="">  <strong>9.6 mins</strong> walk</h5>',
    },
    {
      position: { lat: 1.368480, lng: 103.765327 }, // Education
      icon: './assets/image/map/education-map.png',
      content:'<h4>Assumption English School</h4> <p>624 Upper Bukit Timah Road</p><h5><img src="./assets/image/icons/car.png" alt="">  <strong>4.3 mins</strong> drive</h5>',
    },
    {
      position: { lat:1.36614, lng: 103.77379 }, // Education
      icon: './assets/image/map/education-map.png',
      content:'<h4>GESS - International School</h4> <p>Dairy Farm Lane, Singapore</p>h5><img src="./assets/image/icons/car.png" alt="">  <strong>6.3 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.36699, lng: 103.76745 }, // Education
      icon: './assets/image/map/education-map.png',
      content:'<h4>CHIJ Our Lady Queen of Peace</h4> <p>4 Chestnut Drive</p> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>7.4 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.36169, lng: 103.76762 }, // Education
      icon: './assets/image/map/education-map.png',
      content:'<h4>St Francis Methodist School</h4><p>496 Upper Bukit Timah Road</p> <h5><img src="./assets/image/icons/walk.png" alt="">  <strong>10.6 mins</strong> walk</h5>',
    },
    {
    ...
    },
    {
      ...
      icon: './assets/image/map/education-map.png',
      content:'<h4>National Junior College</h4> <p>37 Hillcrest Road</p><h5><img src="./assets/image/icons/car.png" alt="">  <strong> 17.12 mins</strong> drive</h5>',
    },
    {
      position: { lat: 1.35684, lng: 103.75355 }, // Nature
      icon: './assets/image/map/Nature-map.png',
      content:'<h4>Bukit Batok Town Park</h4>  <p>Bukit Batok East Avenue 5</p> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>5.3 mins</strong> drive</h5>',
 
    },
    {
      position: { lat: 1.35008, lng: 103.77620 }, // Nature
      icon: './assets/image/map/Nature-map.png',
      content:'<h4>Hindhede Nature Park</h4> <p>23 Hindhede Drive</p><h5><img src="./assets/image/icons/car.png" alt="">  <strong>11.6 mins</strong> drive</h5>',
 
    },
    {
      position: { lat: 1.36411, lng: 103.77637 }, // Nature
      icon: './assets/image/map/Nature-map.png',
      content:'<h4>Dairy Farm Nature Park</h4> <p>Thomson Road</p> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>14.7 mins</strong> drive</h5>',
 
    },
    {
      position: { lat: 1.35432, lng: 103.77694 }, // Nature 
      icon: './assets/image/map/Nature-map.png',
      content:'<h4>Bukit Timah Nature Reserve</h4> <p>Thomson Road</p> <h5><img src="./assets/image/icons/car.png" alt="">  <strong>15.8 mins</strong> drive</h5>',
